			...
			<tr>
				...
				<td align="right">
					...
					?>
						...
						<input name="RedirectPage" type="hidden" value="/session/listing/<?php echo $this->session->userdata('CurrentEventID');?>" />
						<div ng-switch="session.withconfirmation">
							<div ng-switch-when="1">
								<div ng-switch="session.inuserschedule">
									<div ng-switch-when="1">
										<button type="submit" name="submitRemove" class="btn btn-warning"><span class="glyphicon glyphicon-remove"></span></button>
									</div>
									<div ng-switch-default="">
										<button type="submit" name="submitInclude" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span></button>
									</div>
								</div>
							</div>
							<div ng-switch-default="">
